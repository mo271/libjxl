...
DEFINE_bool(qprogressive_ac, false,  // TODO(tfish): Wire this up.
...
DEFINE_bool(use_experimental_encoder_heuristics, false,  // TODO(tfish): Wire this up.
...
int main(int argc, char** argv) {
  ...
  {  // Processing tuning flags.
    ...
    ProcessTristateFlag("dots", FLAGS_dots,
                        jxl_encoder_frame_settings,
                        JXL_ENC_FRAME_SETTING_DOTS);
    ProcessTristateFlag("patches", FLAGS_patches,
                        jxl_encoder_frame_settings,
                        JXL_ENC_FRAME_SETTING_PATCHES);
    ProcessTristateFlag("gaborish", FLAGS_gaborish,
                        jxl_encoder_frame_settings,
